...
thingskit.app/
  Contents/
    Info.plist              CFBundleIdentifier = app.sowell.thingskit
...
| ID | Type | Description |
|----|------|-------------|
| BNDL-01 | Unit | Le générateur d'`Info.plist` pose `CFBundleIdentifier = app.sowell.thingskit` et `CFBundleExecutable = thingskit` |
...
| BNDL-07 | Manuel | `codesign -dv --verbose=4` rend `Identifier=app.sowell.thingskit` et `TeamIdentifier=56AP2NSB54` |
